...
INPUT_IMAGE  = "SIRIUS_A_input.png"
OUTPUT_IMAGE = "SIRIUS_A_input_DIFF_2.png"

# --- Telescope geometry ---
APERTURE_MM           = 200    # primary aperture diameter              [mm]
FOCAL_LENGTH_MM       = 490.0   # focal length                           [mm]
CENTRAL_OBSCURATION   = 0.0     # secondary/primary diameter ratio       [0, 1)
FOV_X_ARCSEC          = 97.47  # horizontal field of view               [arcsec]
